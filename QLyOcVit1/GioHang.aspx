            ...
            <div class='col-lg-3 col-md-4 col-12 p-1'>
                <a href='/XemSanPham.aspx?id=<%= model.MaSP %>' style="color: inherit; text-decoration: none;">
                    <div class='card'>
                        ...
                        <div class='card-body'>
                            <h5><%= model.Name %></h5>
                            <p><span class='material-symbols-outlined'>sell</span> <%= model.DonGia.ToString("n0") %>₫ / 1 <%= model.DVT %></p>
                            <p class='text-warning'>
                             <% for (int j = 1; j <= 5; j++) {
                                    if (model.DanhGia >= j) { %>
                                        <span class='material-symbols-outlined-filled'>star</span>
                             <%     }
                                    else if (model.DanhGia >= j - 0.5) { %>
                            ...
                            <div class="d-block text-right">
                                <a class="btn btn-danger p-2 d-inline-flex justify-content-center align-items-center" href="#xacNhanXoa" onclick="$('#<%= index.ClientID %>').val(<%= current %>)" data-toggle="modal">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success" runat="server" onserverclick="ThanhToan">Có</button>
